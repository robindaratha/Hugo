---
title: "WMI Berechtigungen via Powershell"
date: 2024-07-09T20:30:26+02:00
draft: false  
tags: 
    - Powershell
    - How-To
...
WMI Berechtigungen müssen z.B. für Inventory Serviceaccounts eingerichtet werden, wenn diese keine lokalen Administartrorenrechte auf dem jeweiligen System haben sollen. Hier ein Beispiel von Matrix42: [Matrix42 Supportseite](https://help.matrix42.com/020_ESM/10_Service_Management/010ServiceStore_Platform_Guide/030Integration/Built-in_data_providers/Virtual_infrastructure%2C_software%2C_and_hardware_inventory/Prerequisites_for_Windows_inventory)

# Skript

Nachfolgend ist das Skript zu finden:
...
```powershell
.\Set-WmiNamespaceSecurity.ps1 root/<wmi namespace> add <useraccount> Enable,RemoteAccess
```
